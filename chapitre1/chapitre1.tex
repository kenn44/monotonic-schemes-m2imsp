...
\section{Controle quantique bilinéaire}
On rappelle que 
l'équation de Schrödinger:
\begin{equation} \label{schrodinger}
i \hbar \dfrac{\partial }{\partial t} \psi (x,t) = H(x)\psi (x,t)
\end{equation}
Nous travaillons en unités atomiques ($\hbar=1$) a
...
\begin{cases}
i \dfrac{\partial }{\partial t} \psi (x,t) &= H(x)\psi (x,t)-\mu(x)\varepsilon(t)\psi (x,t) \\
\psi (x,t=0) &= \psi_0(x)
\end{cases}
\end{equation}
