...
La méthode du splitting d’opérateur encore appellee est une méthode numérique permettant de résoudre des équations différentielles décomposables en somme d'opérateurs différentiels.
\begin{pro}
