...
i \hbar \dfrac{\partial }{\partial t} \psi (x,t) = H(x)\psi (x,t)
\end{equation}
...
\begin{cases}
i \hbar \dfrac{\partial }{\partial t} \psi (x,t) &= H(x)\psi (x,t)-\mu(x)\varepsilon(t)\psi (x,t) \\
\psi (x,t=0) &= \psi_0(x)
\end{cases}
\end{equation}
...
(Plan)
%Dans ce travail, nous construisons et implémentons une telle discretisation. Dans le premier chapitre nous introduisons la mécanique quantique en trois postulats. Dans le chapitre trois, nous presentons le resultats de nos simulations.
